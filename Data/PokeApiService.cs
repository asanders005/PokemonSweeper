...
namespace PokemonSweeper.API
{
    public static class PokeApiService
    {
        ...
        public static async Task<Pokemon> GetPokemonByDexNumber(int dexNum)
        {
            ...
            var stats = pokemonData.AsBsonArray;
            ...
            return new Pokemon
            {
                ...
                {
                    HP = stats[0]["base_stat"].AsInt32,
                    Attack = stats[1]["base_stat"].AsInt32,
                    Defense = stats[2]["base_stat"].AsInt32,
                    SpecialAttack = stats[3]["base_stat"].AsInt32,
                    SpecialDefense = stats[4]["base_stat"].AsInt32,
                    Speed = stats[5]["base_stat"].AsInt32
                },
